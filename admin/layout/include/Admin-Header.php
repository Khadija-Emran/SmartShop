        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
			 <a class="navbar-brand" href="#"><h2 class="text-light h2"><span class="o">SKA</span>M<i class="fa fa-shopping-cart o"></i>ON</h2></a>
              <div class="bottom-border pb-3">
                <img src="images/cart-com3.jpg" width="50" class="rounded-circle mr-3">
                ...
                <div class="col-md-5">
                  <form>
                    <div class="input-group">
                      ...
                      <button type="button" class="btn btn-white search-button"><i class="fa fa-search icons"></i></button>
                    </div>
                  </form>
                </div>
                <div class="col-md-3">
